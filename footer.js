document.addEventListener('DOMContentLoaded', function() {
    ...
    <footer>
        <div class="container">
            <div class="footer-contacts" style="margin-bottom:10px;">
                <a href="https://www.instagram.com/firetraceindia" target="_blank" style="margin-right:15px; color:#fff; text-decoration:none; display:inline-block;">
                ...
                <a href="https://www.facebook.com/firetraceindia" target="_blank" style="margin-right:15px; color:#fff; text-decoration:none; display:inline-block;">
    ...
    <div class="fab" onclick="toggleFabOptions()">
        ...
        <div id="fab-options" class="fab-options">
            <a href="tel:+919967535401">📞 Phone</a>
            <a href="https://wa.me/919967535401" target="_blank">💬 WhatsApp</a>
            <a href="mailto:info@firetrace.com">📧 Email</a>
        </div>
    </div>
    `;
