...
function renderServiceDetail() {
    ...
    container.innerHTML = `
        ...
        <div class="service-detail-info">
            ...
            <button class="buy-btn" onclick="alert('Thank you for your interest! Our team will contact you soon.')">Buy Now</button>
            <br>
            <a href="ourservice.html" style="color:#fff;background:#b31217;padding:10px 24px;border-radius:20px;text-decoration:none;">Back to Services</a>
        </div>
    `;
    ...
    suggestions.forEach(s => {
        suggestionsHTML += `
            <div class="suggestion-card" tabindex="0" onclick="location.href='service-detail.html?id=${s.id}'" style="cursor:pointer;outline:none;">
